  ...
  <div style="margin: 0 auto !important; padding-left: 0px; padding-right: 0px">
	...
	<form:form name="formularioperformance" action="/portaltpe/home/informs/performance">
	  ...
	  <c:forEach items="${model.tickets}" var="org"> 	
		<object style="width: 100%;" height="950" data="${origen.urlDetalle}efresh=1m&orgId=3&var-ID_CLIENTE=${org.organizationName}&var-LAT=50&var-boton=DISPONIBILIDAD&var-pPRINCIPAL=smc_performance_historico&var-ambiente=QA&kiosk&theme=light&orgId="></object>
	  </c:forEach>
	  </c:forEach>
     </form:form>
