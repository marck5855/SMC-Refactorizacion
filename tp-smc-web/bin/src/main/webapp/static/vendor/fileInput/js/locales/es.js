...
(function ($) {
    ...
    $.fn.fileinputLocales['es'] = {
        ...
        msgFilesTooMany: 'El numero de archivos seleccionados a cargar <b>({n})</b> excede el limite maximo permitido de <b>{m}</b>.',
        ...
        msgInvalidFileName: 'Caracteres no validos o no soportados en el nombre de archivo "{name}".',
        msgInvalidFileType: 'Tipo de archivo no valido para "{name}". Solo se permiten archivos de tipo "{types}".',
        msgInvalidFileExtension: 'Extension de archivo no valido para "{name}". Solo se permiten archivos "{extensions}".',
        msgFileTypes: {
            'image': 'image',
            'html': 'HTML',
            'text': 'text',
        ...
        msgUploadEnd: 'Hecho',
        msgUploadEmpty: 'No existen datos validos para el envio.',
